...
from organization.agenda.models import EventBlock, EventImage, EventDepartment,\
     EventLink, EventPerson, EventPlaylist, EventPeriod, EventTraining,\
     EventRelatedTitle, DynamicContentEvent
from organization.core.models import LinkType
from django.core.exceptions import ValidationError
from mezzanine_agenda.models import EventCategory, ExternalShop, EventPrice, Event,\
    Season
import datetime
...
class EventTests(TestCase):
    ...
    def test_event_start_end_date(self):
        event = Event(
            ...
            title="parent_event",
            user=self._user,
            end=datetime.datetime.strptime("2018-01-14", "%Y-%m-%d").date()
        )
    ...
    def test_event_retrieval(self):
        ...
        self.assertTrue(
            self.event in Event.objects.filter(no_price_comments="no_price_comments")
        )
