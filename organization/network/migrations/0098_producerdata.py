...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('organization-network', '0097_auto_20170406_1047'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='producer_data', to='organization-network.Organization', verbose_name='organization')),
            ],
            options={
