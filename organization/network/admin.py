...
class PersonAdmin(BaseTranslationOrderedModelAdmin):
    ...
    list_filter = ['person_title', 'created', 'activities__date_from', 'activities__date_to', 'user',
...
admin.site.register(PersonProfessionalCategory)
admin.site.register(PersonSignupReason)
