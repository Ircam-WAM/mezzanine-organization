...
class SearchTestsSelenium(FrontTest):               
    ...
    def _start_search(self,input_search,expected):
        ...
        self.webdriver.find_element_by_xpath('//*[@id="search"]/div[2]/div/div/div/div/form/input').send_keys(input_search)
    ...
    def _search_multi_languages(self,input_search, expected):
        ...
        self.translate_en()
        self.assertTrue(expected in self.webdriver.page_source)
        self.webdriver.find_element_by_xpath('//*[@id="container"]/main/div/div/div[2]/div[2]/div/div/a').click()
