...
urlpatterns = [
    ...
    url("^article%s$" % _slash, ArticleListView.as_view(), name="magazine-article-list"),
    url("^article/list/(?P<type>.*)%s$" % _slash, ArticleListView.as_view(), name="magazine-article-type-list"),
    ...
    url("^dynamic-content-magazine/$",  permission_required('magazine.can_edit')(DynamicContentMagazineContentView.as_view()), name='dynamic-content-magazine'),
